 ...
 * Time: 23:37
 */
class Api_Article_Comment extends PhalApi_Api{

    private static $Domain = null;
    public function __construct()
    {
        if (self::$Domain == null) {
            self::$Domain = new Domain_Article_Comment();
        }
    }
    ...
    public function getRules()
    {
        return [
            'Add'=>[
                ...
                'content'   => ['name'=>'content','type'=>'string','min'=>1,'max'=>255,'require' => true,'desc' => '评论内容'],
                'pid'       => ['name'=>'pid','type'=>'int','require' => true,'desc' => '文章父级id'],
                'type'      => ['name'=>'type','type' => 'enum' , 'range' => array(0),'default'=>0,'desc' => '所属板块   0:文章'],
                'lid'       => ['name'=>'lid','type' => 'int' , 'require' => true,'desc' => '所属板块详情id'],
            ],
